...
在设置沙盒分配之前，请确认您具有所需的权限。 要在Experimentation Accelerator中访问&#x200B;**[!UICONTROL 管理]**，您必须具有&#x200B;**[!UICONTROL 管理配置]**&#x200B;权限。

只有在同时满足以下两个条件时，用户才能将[!DNL Target]工作区分配给沙盒：

* 用户在Experimentation Accelerator中具有&#x200B;**[!UICONTROL 管理配置]**&#x200B;权限。
...
1. 在Experimentation Accelerator中，打开&#x200B;**[!UICONTROL 管理]**。
